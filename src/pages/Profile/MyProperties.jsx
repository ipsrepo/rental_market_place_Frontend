...
const MyProperties = ({properties, onEdit, deleteProperty}) => {
    ...
    return (<div>
        <div className="flex items-center justify-between mb-4">
            ...
            <Link to='/addProperty'>
                <button
                    className="bg-primary cursor-pointer text-white text-sm font-medium px-4 py-2 rounded-lg hover:bg-primary transition-colors flex items-center gap-1.5">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {properties.map((property) => (<div key={property._id} className="relative group">
                ...
                <div className="mt-2 flex gap-2">
                    ...
                    <button
                        ...
                        className={`flex-1 flex items-center justify-center gap-1.5 text-sm font-medium py-2 rounded-lg transition-colors border ${property.available ? 'bg-white border-orange-300 text-orange-600 hover:bg-orange-50' : 'bg-white border-green-300 text-green-600 hover:bg-green-50'}`}
                    >
                        Delete Property
                    </button>
                </div>
